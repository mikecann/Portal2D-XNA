...
namespace Portal2D.Font
{
	...
	public class BitmapFont
	{
        ...
        private bool _customBatch;
        public SpriteBatch Batch { set { m_sb = value; _customBatch = true; } }
		...
		public int DrawString(Vector2 vOrigin, Color color, string format, params object[] args)
		{
            ...
            if (!_customBatch) { m_sb.Begin(SpriteBlendMode.AlphaBlend); }
